  ...
  return Card(
    child: Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: const [
          Text('フィードバック', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.green)),
          Divider(),
          SizedBox(height: 8),
          Text('これまでタスクを頑張り、タスクが溜まり切り直前に完了する傾向があります。もっと早めに着手しやすい環境を作り、先延ばしを防ぎましょう。うるおいのタスクでモチベーションを確保し「習慣の場所と時間」を作ってあげることと、「これを聞き終わったらすぐ着手」など、週間の目標を「0→1の小さな行動」に変えていくことです。日曜日が最も先延ばしリスクがあるため、まずココから対策を始めましょう。', style: TextStyle(fontSize: 14)),
        ],
      ),
    ),
  );
